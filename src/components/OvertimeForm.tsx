...
export default function OvertimeForm({ entry, defaultDate, onSave, onCancel }: Props) {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md bg-[#080808] rounded-xl p-6"
        style={{
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <Field label="DATE // 日付">
            <input
              ...
              required
              className="w-full bg-[#111] border border-gray-700 rounded-lg px-3 py-2.5 text-white font-mono text-sm outline-none transition-all focus:border-[#00f5ff]"
          ...
          {durationStr && (
            <div
              className="text-center py-2 font-mono text-sm tracking-widest"
          ...
          <Field label="TASK // 作業内容">
            <textarea
              ...
              rows={3}
              className="w-full bg-[#111] border border-gray-700 rounded-lg px-3 py-2.5 text-white font-mono text-sm outline-none transition-all resize-none placeholder-gray-700 focus:border-[#00f5ff]"
            />
          </Field>
